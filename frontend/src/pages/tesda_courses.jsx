...
import TesdaFlush from "./components/tesda_flush.jsx";
...
export default function TesdaCourses() {
  ...
  // Fetch description
  useEffect(() => {
    fetch(`${APP_URL}/api/user-display-basic-info?title=Tesda%20Courses`)
  ...
  useEffect(() => {
    fetch(`${APP_URL}/api/display-in-user-tesda-categories`)
      .then((response) => response.json())
      .then((categoriesData) => {
        ...
        <section className="learning-resources-section">
          <div className="learning-resources-content">
            <div className="learning-resources-heading d-flex align-items-center">
              ...
              <h3 className="title text-uppercase fw-bold">Tesda Courses</h3>
            </div>
            ...
            categories
              ...
              .map((category, index) => (
                ...
                >
                  ...
                  <TesdaFlush categoryId={category.category_id} />
                </div>
              ))
          ) : (
            <p></p>
